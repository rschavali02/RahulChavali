      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-8 mb-12">
          ...
          <div className="flex-1 text-center md:text-left">
            <h1 className="text-4xl font-bold mb-2">Hi there, I'm Your Name 👋</h1>
            <p className="text-xl mb-4">I study Computer Science & Mathematics @ University</p>
          ...
          <TabsContent value="about" className="mt-6">
            <Card className="bg-gray-800 border-gray-700">
              ...
              <CardContent className="space-y-4">
                <p>
                  I'm a passionate student studying Computer Science and Mathematics, with a focus on building
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-1">
                    ...
                    <li>Ask me about fantasy football, poker, soccer, or chess!</li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-400">University Name, Expected Graduation 2026</p>
                </div>
              </CardContent>
            </Card>
          </TabsContent>
                ...
                <div>
                  ...
                  <ul className="mt-2 space-y-4">
                    <li className="flex gap-3">
                      ...
                      <div>
                        <p className="font-medium">President of the Student Fellowship</p>
                        <p className="text-gray-400">
                          Leading an organization committed to helping Engineering Students succeed
                        </p>
                      </div>
                    </li>
                    <li className="flex gap-3">
                      <span className="text-green-400">▹</span>
                      <div>
                        <p className="font-medium">Engineering Intern at Tech Company</p>
                        <p className="text-gray-400">Building AI experiences and voice applications</p>
                      </div>
                    </li>
                  </ul>
                </div>
                  ...
                  <ul className="mt-2 space-y-4">
                    <li className="flex gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-400">Computational Imaging Lab @ University</p>
                      </div>
                    </li>
                    <li className="flex gap-3">
                      <span className="text-green-400">▹</span>
                      <div>
                        ...
                        <p className="text-gray-400">
                          Led development of a campus app using React.js, Node.js, and Firebase
                        </p>
                      </div>
                    </li>
                    <li className="flex gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-400">
                          Built full-stack and ideated product iterations @ Campus Startup
                        </p>
                      </div>
                    </li>
                  </ul>
          ...
          <TabsContent value="projects" className="mt-6">
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <Card className="bg-gray-800 border-gray-700">
                ...
                <CardContent>
                  <p>An interactive web-based product presentation platform for showcasing projects.</p>
                </CardContent>
                <CardFooter>
                  <div className="flex gap-2">
